    ...
    <div>
      <>
        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 md:px-8">
          {/* Grid */}
          <div className="grid md:grid-cols-7 md:gap-x-8 xl:gap-x-12 md:items-center">
            ...
            <div className="md:col-span-3 mt-5">
              <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-6xl">
              ...
              <div className='mt-8'>
                <Link href="/signup" className='bg-blue-500 p-3 px-5 rounded-xl text-xl hover:bg-blue-700'>Get Started</Link>
              </div>
            </div>
            {/* End Col */}
      ...
      <div className='bg-slate-100 py-8'>
        <div>
          <div className='mt-10'>
            <h2 className='text-5xl font-bold text-center'>Past Programs</h2>
          </div>
          <div className='mx-16 my-5'>
            <div className='md:flex md:justify-between md:items-center pt-10'>
              <Link href='/organization'>
                <div className=''>
                  <article
                    class="hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]"
                  >
                    <div class="rounded-[10px] bg-white p-4 !py-10">
                      <h2 className='text-center text-xl text-blue-500'>2023 Program</h2>

                      <h3 class="mt-0.5 text-md text-gray-900 text-center py-1">
                        959 projects were completed with 171 open source organizations.
                      </h3>
                    </div>
                  </article>
                </div>
              ...
              <Link href='/organization'>
                <div className='md:px-5'>
                  <article href="/organization"
                    class="hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-duration:_4s]"
                  >
                    <div class="rounded-[10px] bg-white p-4 !py-10">
                      <h2 className='text-center text-xl text-blue-500'>2022 Program</h2>

                      <h3 class="mt-0.5 text-md text-gray-900 text-center py-1">
                        1166 projects were completed with 202 open source organizations.
                      </h3>
                    </div>
                  </article>
                </div>
              ...
              <Link href='/organization'>
                <div className=''>
                  ...
                  >
                    <div class="rounded-[10px] bg-white p-4 !py-10">
                      <h2 className='text-center text-xl text-blue-500'>2021 Program</h2>
            ...
            <div className='md:flex md:justify-between md:items-center'>
              <Link href='/organization'>
                <div className='md:pr-5 mt-5'>
                  ...
                  >
                    <div class="rounded-[10px] bg-white p-4 !py-10">
                      <h2 className='text-center text-xl text-blue-500'>2020 Program</h2>

                      <h3 class="mt-0.5 text-md text-gray-900 text-center py-1">
                        1198 projects were completed with 199 open source organizations.
                      </h3>
                    </div>
                  </article>
                </div>
              ...
              <div className='md:pr-5 mt-5'>
                ...
                >
                  <div class="rounded-[10px] bg-white p-4 !py-10">
                    <h2 className='text-center text-xl text-blue-500'>2019 Program</h2>

                    <h3 class="mt-0.5 text-md text-gray-900 text-center py-1">
                      1134 projects were completed with 206 open source organizations.
                    </h3>
                  </div>
                </article>
              </div>
              ...
              <div className='mt-5'>
                ...
                >
                  <div class="rounded-[10px] bg-white p-4 !py-10">
                    <h2 className='text-center text-xl text-blue-500'>2018 Program</h2>

                    <h3 class="mt-0.5 text-md text-gray-900 text-center py-1 ">
                      1072 projects were completed with 206 open source organizations.
                    </h3>
                  </div>
                </article>
              </div>
            ...
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
              ...
              <div className="w-2/3 sm:w-1/2 lg:w-1/3 mx-auto text-center mb-6">
                <h2 className="text-gray-600 text-xl">
                  Trusted by Open Source, Organization, and more than 99,000 of you
                </h2>
              </div>
              {/* End Title */}
              {/* Grid */}
          ...
          <div>
            <section className="bg-slate-100">
              <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                ...
                <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 overflow-y-auto">
                  <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-lg font-medium text-gray-900">Sandeep Yadav</p>
                      </div>
                    </div>
                  ...
                  <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-lg font-medium text-gray-900">Sarthak Verma</p>
                      </div>
                    </div>
                  ...
                  <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-lg font-medium text-gray-900">Priyam Kesarwani</p>
                      </div>
                    </div>
